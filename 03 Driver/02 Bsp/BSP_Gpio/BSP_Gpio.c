...
/* 初始化引脚
  ...
  返回值：成功true，失败false
*/
bool BSP_Init_Pin(BSP_PORT_ENUM port_number, BSP_PIN_ENUM pin_number, BSP_IO_TYPE_ENUM type)
{
	...
	if((port_number == _PA_) && ((pin_number == _P13_) || (pin_number == _P14_)))		/*初始化PA13、PA14*/
	{
		/*使能复用时钟*/
